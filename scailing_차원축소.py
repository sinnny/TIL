...
# 2. 2차원 축소
from sklearn.preprocessing import StandardScaler as standara
m_sc = standard()
...
m_knn1.score(test_x1, test_y1)  # 0.9736842105263158
...
m_knn2.fit(train_x2, train_y2)  # KNeighborsClassifier()
